{{-- 
    Файл: resources/views/winter-analytics/index.blade.php
    Страница с аналитической запиской по подготовке к зиме
--}}
@extends('layouts.admin')

@section('title', 'Подготовка к зиме - Аналитика')
...
<div class="container-fluid mt-4">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            ...
            <select id="categoryFilter" class="form-select" style="border-color: #28a745;">
                ...
                <div class="card-body">
                            ...
                            <div class="col-md-3">
                                <div class="metric-card bg-light">
                                    <div class="metric-value text-primary">
                                        {{ number_format($analytics['raw_data']['total']['plan'], 0, ',', ' ') }}
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="metric-card bg-light">
                                    <div class="metric-value text-success">
                                        {{ number_format($analytics['raw_data']['total']['fact'], 0, ',', ' ') }}
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="metric-card bg-light">
                                    <div class="metric-value text-danger">
                                        {{ number_format($analytics['raw_data']['total']['diff'], 0, ',', ' ') }}
                                    </div>
                                    <div class="metric-label">Отставание</div>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="analytics-section mb-4">
                        <h5 class="section-title text-success">
                            <i class="mdi mdi-trophy"></i> Лидеры выполнения
                        </h5>
                            ...
                            @foreach($analytics['recommendations'] as $rec)
                                @php
                                    ...
                                    $recIcon = $rec['priority'] === 'high' ? 'mdi-alert' : 
                                              ($rec['priority'] === 'medium' ? 'mdi-alert-circle-outline' : 'mdi-information-outline');
                                @endphp
...
$(document).ready(function() {
    // При изменении любого Select - перезагружаем страницу
